...
// ID goi cap nhat
$nv_update_config['packageID'] = 'NVUDACCOMMODATION4200';

// Cap nhat cho module nao, de trong neu la cap nhat NukeViet, ten thu muc module neu la cap nhat module
$nv_update_config['formodule'] = 'accommodation';

// Thong tin phien ban, tac gia, ho tro
$nv_update_config['release_date'] = 1526235133;
$nv_update_config['author'] = 'PHAN TAN DUNG (phantandung92@gmail.com)';
$nv_update_config['support_website'] = 'https://github.com/hoaquynhtim99/accommodation/tree/to-4.2.00';
$nv_update_config['to_version'] = '4.2.00';
    ...
    try {
        ...
        if (!$num) {
            $db->query("INSERT INTO " . $db_config['prefix'] . "_setup_extensions (
                ...
                322, 'module', 'accommodation', 0, 1, 'Accommodation', 'accommodation', '" . $nv_update_config['to_version'] . " " . $nv_update_config['release_date'] . "', " . NV_CURRENTTIME . ", '" . $nv_update_config['author'] . "',
